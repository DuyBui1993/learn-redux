...
import {editTodo, removeTodo, toggleComplete} from "@/features/todo.slices";
...
export function TodoItem({id, text, completed}: TodoItemProps) {
    ...
    return (
        <div
            className="flex items-center justify-between p-4 bg-white rounded-lg shadow-md transition-all duration-300 hover:shadow-lg">
