      ...
      <div className="col-span-1 md:col-span-2 flex flex-col items-center justify-center mx-4 md:mx-24 relative">
        ...
        <form className="space-y-4 w-full" onSubmit={handleSubmit}>
          ...
          <div className="relative">
            ...
            />
            <span className="absolute left-4 top-1/2 transform text-lg text-gray-600">
              <AiOutlineUser />
            </span>
          </div>
          <div className="relative">
            ...
            <input
              ...
              placeholder="Nhập..."
            />
            <span className="absolute left-4 top-10 transform text-lg text-gray-600">
              <PiKeyLight />
            </span>
          </div>
          ...
          <div className="text-right">
            <a
              href="/dictionary/forgot-password"
          ...
          <div>
            <div className="flex items-center justify-start h-20 w-80 border border-gray-300 bg-gray-50 rounded-sm px-3">
              <input
                type="checkbox"
                id="recaptcha"
                className="mr-2"
