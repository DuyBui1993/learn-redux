                        ...
                        <div>
                            <Menubar>
                                <MenubarMenu>
                                    <MenubarTrigger>
                                        <img
                                            src="https://media-app.zim.vn/Avatar/1_3baceee7-c7d3-41ec-b6d0-5de6aba08ce1.png"
                                            alt=""
                                    ...
                                    <MenubarContent>
                                        <MenubarItem>
                                            <AiOutlineUser className="mr-2" fontSize={20}/> Xem trang cá nhân
                                        </MenubarItem>
                                        <MenubarItem>
                                            <PiTextAa className="mr-2" fontSize={20}/> Từ đã lưu
                                        </MenubarItem>
                                        <MenubarItem>
                                            <AiOutlineSetting className="mr-2" fontSize={20}/> Cài đặt tài khoản
                                        </MenubarItem>
                                        <MenubarSeparator/>
                                        <MenubarItem
                                            className="text-red-600"
                                            onClick={handleLogOut}>
                                            <FiLogOut className="mr-2 text-lg text-red-600"/> Đăng xuất
                                        </MenubarItem>
                                    </MenubarContent>
                                </MenubarMenu>
                            </Menubar>
